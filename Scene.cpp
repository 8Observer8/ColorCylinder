...
void Scene::initializeGL()
{
    ...
    QString path = QDir::currentPath() + QString( "/Models/ColorCylinder.obj" );
    LoaderOfCylinder loader( path );
    ...
    m_cylinder = new Cylinder( &m_program, m_vertexAttrLoc, m_colorAttrLoc, m_normalAttrLoc );
    m_cylinder->loadFromLoader( &loader );
    ...
    m_cameraMatrix.translate( 0.0f, 0.0f, -5.f );
